...
namespace OSMP
{
    public class FractalSplineTube : FractalSplinePrim
    {
        // register our contextmenu
        public static void Register()
        {
            ContextMenuController.GetInstance().RegisterPersistentContextMenu(new string[]{ "&Create...","&Tube" }, new ContextMenuHandler( Create ) );
        }
