...
public class ObjectReplicationServerToClient_ClientProxy : OSMP.NetworkInterfaces.IObjectReplicationServerToClient
{
   ...
   public ObjectReplicationServerToClient_ClientProxy( RpcController rpc, object connection )
   {
      this.rpc = rpc;
   ...
   {
      rpc.SendRpc( connection, "OSMP.NetworkInterfaces.IObjectReplicationServerToClient", "ObjectModified",  new object[]{ reference, entitytypename, entity } );
   }
