    ...
    public class TestNetworkUdp
    {
        public class Server
        {
            ...
            public void Go(int port)
            {
                ...
                net.ReceivedPacket += new ReceivedPacketHandler(net_ReceivedPacket);
                while (true)
                {
                    net.Tick();
                    Thread.Sleep(50);
            ...
            void net_ReceivedPacket(object source, ReceivedPacketArgs e)
            {
                Console.WriteLine("Received packet: " + Encoding.UTF8.GetString(e.Data));
                net.Send(e.Connection, Encoding.UTF8.GetBytes( "Hello from server!" ) );
            }
        }
